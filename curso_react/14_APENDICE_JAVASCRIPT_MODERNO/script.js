function separateThemes(title) {
  console.log("=======================================");
  console.log("===| " + title);
  console.log("=======================================");
}

separateThemes("1 - var, let e const");
var x = 10;
var y = 15;
...
separateThemes("2 - arrow functions");
...
separateThemes("5 - template literals");
...
separateThemes("6 - destructuring");
...
separateThemes("7 - spread operator");
const a1 = [1, 2, 3];
const a2 = [4, 5, 6];
